...
class Graph {
  ...
  public:
	...
	void dijkstra_pq(int s, vector<int>& path, vector<int>& dist);				// To be implemented 
	void topological_dijkstra(int s, vector < int >&path, vector < int >&dist);	// To be implemented
	void bellman_ford(int s, vector<int>& path, vector<int>& dist); 			// To be implemented
	int edges(){
		return E;
	}; 																//Return number of edges - my implementation
	/**
